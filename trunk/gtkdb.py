...
class PyGTKDb(gtk.Window, bdb.Bdb):
    ...
    def __init__(self):
        ...
        actions = [
            ('Next', gtk.STOCK_MEDIA_PLAY, "Next", None, "Next statement", self.do_next),
            ('Step', gtk.STOCK_MEDIA_FORWARD, "Step", None, "Step into function",
             self.do_step),
            ('Return', gtk.STOCK_GOTO_LAST, "Return", None,
             "Continue execution to end of function", self.do_return),
            ('Continue', gtk.STOCK_OK, "Continue", None,
             "Continue execution to next break point", self.do_continue),
            ('Break', gtk.STOCK_MEDIA_STOP, "Break", None,
            ...
            ('Run', gtk.STOCK_EXECUTE, "Run", None,
             "Execute some code in the current stack context", self.do_run),
            ('Quit', gtk.STOCK_CLOSE, "Close", None, "Close the debugger",
             self.do_quit),
            ]
